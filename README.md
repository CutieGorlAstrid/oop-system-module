# `System` module (Python) [![Run on Repl.it](https://repl.it/badge/github/SpeedStriker243/oop-system-module)](https://repl.it/github/CutieGorlAstrid/oop-system-module)
